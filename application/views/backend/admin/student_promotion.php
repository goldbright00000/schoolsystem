...
<div class="row">
    ...
    <center>
        <button class="btn btn-info" type="submit" style="margin:10px;">Manage Promotion</button>
    </center>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center">
                        <button type="button" class="btn btn-default" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/student_promotion_performance/<?php echo $from_class;?>/<?php echo $row['student_id'];?>');">
