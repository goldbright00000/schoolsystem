        ...
        <tbody>
            <form method="post" action="<?php echo base_url();?>index.php?admin/attendance_report_view" class="form">
                <tr class="gradeA">
                    ...
                    <td align="center"><input type="submit" value="Show Report" class="btn btn-info"/></td>
                </tr>
            </form>
        </tbody>
    </table>
...
<div class="row">
    <div class="col-md-12">
        ...
        <center>
            <a href="<?php echo base_url(); ?>index.php?admin/attendance_report_print_view/<?php echo $class_id; ?>/<?php echo $section_id; ?>/<?php echo $month; ?>/<?php echo $year; ?>" class="btn btn-primary" target="_blank">Print Attendance Sheet</a>
        </center>
    </div>
</div>
