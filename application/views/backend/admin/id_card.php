    ...
    <div class="col-md-11">
        ...
        <div id="html-content-holder" class="area" style="background-color: #fff;">
            <div class="side">
                ...
                <div class="row detail" style="font-size: 12px;width: 320px;height: 26px;">
                ...
                <div class="detail" style="width: 320px;height: 26px;font-size: 12px;">
                ...
                <div class="detail" style="width: 320px;height: 26px;font-size: 12px;">
                    ...
                    <div style="float: left;padding-right: 7px;"><p> ул. Арбат, 4с3 Москва 119019</p></div>
                </div>
                <div class="detail" style="width: 320px;height: 26px;font-size: 12px;">
                ...
                <br/>
                <div class="detail" style="width: 320px;height: 20px;font-size: 12px;">
            ...
            <div class="side">
                ...
                <div class="detail">
                    <label>Phone</label>
                    <div><p>+91 65465 56524</p></div>
                    <div><p>+91 65465 56524</p></div>
                </div>
                <div style="height: 7px;"></div>
                <div class="detail">
                    <label>Email</label>
                    <div><p>yourmallid@yourdomain.com</p></div>
                    <div><p>yourmallid01@yourdomain.com</p></div>
                </div>
                <div style="height: 7px;"></div>
                <div class="detail">
                    <label>Website</label>
